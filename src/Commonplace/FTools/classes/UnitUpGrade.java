...
public class UnitUpGrade {
    ...
    public static void getPower(Commonplace.FTools.interfaces.UnitUpGrade uug, int number, boolean get, boolean full) {
        if (full) {
            uug.setLevel(60);
    ...
    private static void getPower(Commonplace.FTools.interfaces.UnitUpGrade uug, int index, int start) {
        switch (list[index]) {
            case "healthy": {
    ...
    private static int getIndex(Commonplace.FTools.interfaces.UnitUpGrade uug) {
