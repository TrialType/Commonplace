...
public class Decoy extends Wall {
    ...
    public void setStats() {
        ...
        if (flexibility > 0) {
            stats.add(CStats.adaptDamageLossMax, adaptDamageMax == 0 ? 1 : adaptDamageMin / adaptDamageMax);
            stats.add(CStats.adaptability, adaptability);
            stats.add(CStats.adaptLoss, adaptLoss);
            stats.add(CStats.flexibility, flexibility);
        }
        if (farDeflectChance > 0) {
            stats.add(CStats.farDeflect, farDeflect);
            stats.add(CStats.farDeflectChance, farDeflectChance);
        }
    }
